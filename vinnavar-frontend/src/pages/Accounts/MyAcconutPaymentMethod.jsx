...
const american = getImageUrl("/media/site/american-express.svg");
const mastercard = getImageUrl("/media/site/mastercard.svg");
const paypal = getImageUrl("/media/site/paypal.svg");
const visa = getImageUrl("/media/site/visa.svg");
const discover = getImageUrl("/media/site/discover.svg");
