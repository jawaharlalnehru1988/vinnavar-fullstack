...
const productimg1 = getImageUrl("/media/products/product-img-1.jpg");
const productimg2 = getImageUrl("/media/products/product-img-2.jpg");
const productimg3 = getImageUrl("/media/products/product-img-3.jpg");
const productimg4 = getImageUrl("/media/products/product-img-4.jpg");
const productimg5 = getImageUrl("/media/products/product-img-5.jpg");
const productimg6 = getImageUrl("/media/products/product-img-6.jpg");
