...
const slider1 = getImageUrl("/media/site/slide-1.jpg");
const abouticon = getImageUrl("/media/site/about-icons-1.svg");
const slider2 = getImageUrl("/media/site/slider-2.jpg");
const adbanner1 = getImageUrl("/media/site/ad-banner-1.jpg");
const adbanner2 = getImageUrl("/media/site/ad-banner-2.jpg");
const adbanner3 = getImageUrl("/media/site/ad-banner-3.jpg");
const attaricedal = getImageUrl("/media/site/atta-rice-dal.png");
...
const bakerybiscuits = getImageUrl("/media/site/bakery-biscuits.png");
const snackmunchies = getImageUrl("/media/site/snack-munchies.png");
const fruitsvegetables = getImageUrl("/media/site/fruits-vegetables.png");
const dairybreadeggs = getImageUrl("/media/site/dairy-bread-eggs.png");
const grocerybanner = getImageUrl("/media/site/grocery-banner.png");
const grocerybanner2 = getImageUrl("/media/site/grocery-banner-2.jpg");
const map = getImageUrl("/media/site/map.png");
const iphone = getImageUrl("/media/site/iphone-2.png");
const googleplay = getImageUrl("/media/site/googleplay-btn.svg");
const appstore = getImageUrl("/media/site/appstore-btn.svg");
...
const product8 = getImageUrl("/media/site/category-pet-care.jpg");
const product9 = getImageUrl("/media/site/category-snack-munchies.jpg");
const product10 = getImageUrl("/media/site/category-tea-coffee-drinks.jpg");
