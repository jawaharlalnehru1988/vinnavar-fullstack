...
const clutch = getImageUrl("/media/site/clutch-dark.png");
const member1 = getImageUrl("/media/site/01.jpg");
const member2 = getImageUrl("/media/site/02.jpg");
const member3 = getImageUrl("/media/site/03.jpg");
// const member4 = getImageUrl("/media/site/04.jpg");
const member5 = getImageUrl("/media/site/member5.jpg");
const member6 = getImageUrl("/media/site/member6.jpg");
const member7 = getImageUrl("/media/site/member7.jpg");
const member8 = getImageUrl("/media/site/member8.jpg");
const idea = getImageUrl("/media/site/idea.gif");
const team = getImageUrl("/media/site/team.gif");
const award = getImageUrl("/media/site/award.gif");

const flipkartlogo = getImageUrl("/media/site/flipkartlogo.png");
const amazonlogo = getImageUrl("/media/site/amazonlogo.png");
const blinkit = getImageUrl("/media/site/blinkit.png");
const smartshop = getImageUrl("/media/site/smartshop.png");

// const bgimage = getImageUrl("/media/site/contact-bg.png");
// const cover = getImageUrl("/media/site/cover.jpg");
                ...
                <div className="container position-relative zindex-5 pt-5">
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <h1 className="pb-2 pb-md-3">About Vinnavar Organics</h1>
